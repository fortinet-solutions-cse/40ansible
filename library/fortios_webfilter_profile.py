...
description:
    - This module is able to configure a FortiGate or FortiOS by
      ...
      Examples are exahustive, please adjust before usage.
      ...
      webfilter_profile:
         ...
         -
            ...
            filters:
             -
                ...
                auth-usr-grp:
                 -
                    name: "default_name41" (source: user.group.name)
                category: "5"
                id: "18"
                log: "enable"
        ...
        override:
         -
            ...
            ovrd-user-group:
             -
                name: "default_name2" (source: user.group.name)
            profile:
             -
                name: "default_name35" (source: webfilter.profile.name)
        ...
        web:
         -
            blacklist: "enable"
            bword-table: "20" (source: webfilter.content.id)
            bword-threshold: "26"
            content-header-list: "7" (source: webfilter.content-header.id)
            keyword-match:
             -
                pattern: "<your_own_value>"
            log-search: "enable"
            safe-search: "url"
            urlfilter-table: "3" (source: webfilter.urlfilter.id)
            whitelist: "exempt-av"
        ...
        wisp-servers:
         -
            name: "default_name49" (source: web-proxy.wisp.name)
        youtube-channel-filter:
         -
        ...
        "webfilter_profile": {
            ...
            "options": {
                ...
                "ftgd-wf": {"required": False, "type": "dict",
                    "options": {
                        "exempt-quota": {"required": False, "type": "int"}, 
                        "filters": {"required": False, "type": "list",
                            "options": {
                                "action": {"required": False, "type": "str",
                                    "choices": ["block", "authenticate", "monitor", "warning"]}, 
                ...
                "name": {"required": True, "type": "str"}, 
                "options": {"required": False, "type": "str",
                    "choices": ["activexfilter", "cookiefilter", "javafilter", "block-invalid-url", "jscript", "js", "vbs", "unknown", "intrinsic", "wf-referer", "wf-cookie", "per-user-bwl"]}, 
                "override": {"required": False, "type": "dict",
                    "options": {
                        ...
                        "ovrd-scope": {"required": False, "type": "str",
                            "choices": ["user", "user-group", "ip", "browser", "ask"]}, 
